<div class="menu"> 
	 ...
	 <div class="menu_option" onclick="window.location.href = 'bienvenido.php';">Bienvenido</div>
	 <div class="menu_option" onclick="window.location.href = 'preguntas.php';">Preguntas</div>
