<div class="menu"> 
	 ...
	 <div class="menu_option" onclick="window.location.href = 'noimplementado.php';">Encuestas</div>
	 ...
	 <div class="menu_option" onclick="window.location.href = 'noimplementado.php';">Tabla JQuery</div>
